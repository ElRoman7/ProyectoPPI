...
?>
    <div class="titulo-pag">
        <h2 class="no-margin">Editando Promocion</h2>
    </div>
    ...
    <main class="contenedor">
        <form enctype="multipart/form-data" class="formulario" name="Forma01" method="post" action="promociones_actualizar.php" id="PromocionesActualizar">
